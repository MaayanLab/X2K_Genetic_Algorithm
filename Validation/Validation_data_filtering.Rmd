...
```{r}
setwd("~/Dropbox/Maayan_Lab/X2K/4) Validation_datasets/")
library(cogena)
...
library(readxl)
kinome <- read_excel("Drug-Target_Data/Kinome_Hsap.xls")
...
file.remove("Perturbation_Data/CREEDS/Filtered_GMTs/CREEDS_DG.TC_filtered.gmt")
gmtlist2file(CREEDS_manualDrugs_DB.TC, "Perturbation_Data/CREEDS/Filtered_GMTs/CREEDS_Manual.Drugs_DG.TC_filtered.gmt")    
```
